...
CREATE TABLE Administrator(
	JMBG VARCHAR(13) UNIQUE PRIMARY KEY NOT NULL,
...
ALTER TABLE Class ADD CONSTRAINT CTFK FOREIGN KEY (Teacher) REFERENCES Teacher(Id);

ALTER TABLE Class ADD CONSTRAINT CSFK FOREIGN KEY (Teacher) REFERENCES Student(Id);
...
ALTER TABLE Teaches ADD CONSTRAINT TTFK FOREIGN KEY (Teacher_Id) REFERENCES Teacher(Id);

ALTER TABLE Teaches ADD CONSTRAINT TLFK FOREIGN KEY (Language_Id) REFERENCES Language(Id);

ALTER TABLE Teaches ADD CONSTRAINT HPK PRIMARY KEY (Language_Id, Teacher_Id);
...
INSERT INTO Administrator VALUES ("1234567890123", "Admin", "Adminovic", "Male", 10, "admin@mail.com", "admin123", "Admin", 1);

INSERT INTO Student VALUES ("1234567890123", "Ana", "Anic", "Female", 1, "ana@mail.com", "ana123", "Student", 1);
INSERT INTO Student VALUES ("1234567890123", "Bojan", "Bojanic", "Male", 2, "bojan@mail.com", "bojan123", "Student", 1);

INSERT INTO School VALUES (1, "Skola 1", 3, 1);
INSERT INTO School VALUES (2, "Skola 2", 4, 1);

INSERT INTO Teacher VALUES ("1234567890123", "Sanja", "Sanjic", "Female", 5, "sanja@mail.com", "sanja123", "Teacher", 1, 1);
INSERT INTO Teacher VALUES ("1234567890123", "Tihomir", "Tihomiric", "Male", 6, "tihomir@mail.com", "tihomir123", "Teacher", 1, 2);

INSERT INTO Language VALUES (1, "srpski", 1);
INSERT INTO Language VALUES (2, "engleski", 1);
INSERT INTO Language VALUES (3, "spanski", 1);

INSERT INTO HasLanguage VALUES (1, 1);
INSERT INTO HasLanguage VALUES (2, 2);
